...
class TestKauppa(unittest.TestCase):
    ...
    def test_2_eri_tuotteen_ostoksen_paaytyttya_pankin_metodia_tilisiirto_kutsutaan_arvoilla(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
        ...
        # varmistetaan, että metodia tilisiirto on kutsuttu
        pankki_mock.tilisiirto.assert_called_with("pekka", 42, "12345", kauppa._kaupan_tili, 11)
        # toistaiseksi ei välitetä kutsuun liittyvistä argumenteista

    def test_2_saman_tuotteen_ostoksen_paaytyttya_pankin_metodia_tilisiirto_kutsutaan_arvoilla(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_varastossa_ja_ei_varastossa_olevan_tuotteen_ostoksen_paaytyttya_pankin_metodia_tilisiirto_kutsutaan_arvoilla(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_metodin_aloita_asiointi_kutsuminen_nollaa_edellisen_ostoksen_tiedot(self):
        ...
        pankki_mock.tilisiirto.assert_called_with("pekka", 42, "12345", kauppa._kaupan_tili, 6)
